...
class ProfileLocalRepositoryImpl @Inject constructor(
    ...
    override suspend fun saveCredentialsToLocalStorage(username: String,firstname:String,lastname:String,phone: String,email:String,profileImage:String,gender:String) {
        authLocalDataSource.saveCredentials(username = username,firstname=firstname, lastname = lastname,phone=phone,email=email,profileImage=profileImage,gender=gender)
    }
